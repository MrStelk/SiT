...
export PROJECT="SiT-B-2-ImageNet100"
...
accelerate launch --multi_gpu --num_processes 2 --mixed_precision bf16 train.py \
    ...
    --image-size 256 \
    --epochs 1400 \
    --global-batch-size 450 \
    --num-classes 100 \
    --wandb \
    --ckpt /home/venky/dkarthik/baselines/SiT/results/004-SiT-B-2-Linear-velocity-None/checkpoints/1124_0405000.pt.pt \
    --num-workers 8 \
    --ckpt-every 15000
